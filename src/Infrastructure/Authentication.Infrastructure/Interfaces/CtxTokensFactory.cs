...
namespace Infrastructure.Interfaces
{
    ...
    public class CtxTokensFactory : IDesignTimeDbContextFactory<CtxTokens>
    {
        public CtxTokensFactory()
        {
            // A parameter-less constructor is required by the EF Core CLI tools.
        }

        public CtxTokens CreateDbContext(string[] args)
        {
            ...
            //   .Options;
            return new CtxTokens(connectionString);
        }
    }
}
